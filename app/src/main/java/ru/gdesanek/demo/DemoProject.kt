...
object DemoProject {
    fun load(context: Context): Long {
        ...
        objects.insert(projectId, "furn_kitchen", 136f, 76f, 0f, "Кухня", 0f, -1)
        objects.insert(projectId, "furn_bed2", 484f, 126f, 90f, "Кровать", 0f, -1)
        objects.insert(projectId, "furn_sofa", 186f, 315f, 0f, "Диван", 0f, -1)
        objects.insert(projectId, "furn_table", 341f, 315f, 0f, "Стол", 0f, -1)
